        ...
        <>
            <div class="row">
                    ...
                    <div class="card card-demo">
                        <div class="card-body">
                            <ul className="nav nav-tabs nav-top-border no-hover-bg">
                                <li className="nav-item"> <a className="nav-link active" id="base-tab11" data-toggle="tab" aria-controls="tab11" href="#tab11" aria-expanded="true">Subject Teacher Mapping</a> </li>
                            </ul>
                                    ...
                                    <div className="row">
                                        <div className="col-12 mt-2">
                                            <div className="form-group">
                                                <label className="label-control mb-2">Select Subject<span
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card card-demo">
                        <div class="card-body">
                            <h3 class="card-title">Subject Teacher Mapping List</h3>
                            <div className="row">
...
export default AcadMapSubjectTeacher;
