                            ...
                            <div className="row">
                                <div className="col-6 mt-2">
                                    <div className="form-group">
                                        <label className="label-control mb-2">Language Name<span
                                ...
                                <div className="col-6 mt-2">
                                    <div className="form-group">
                                        <label className="label-control mb-2">Language Code<span
                                            className="red">*</span></label>
                                        <input className="form-control" data-val="true"
                                            id="AccountName"
                                            maxlength="50" name="AccountName" placeholder="Class Name"
                                ...
                                <div className="col-6 mt-2">
                                    <div className="form-group">
                                        <label className="label-control mb-2">Language File<span
                                            className="red">*</span></label>
                                        <input className="form-control" data-val="true"
                                            id="AccountName"
                                            maxlength="50" name="AccountName" placeholder="Class Name"
                                ...
                                <div className="col-6 mt-3">
                                    <div className="form-group">
                                        <br />
                                        <button type="submit"
                                            className="btn btn-primary box-shadow-1 round btn-min-width mr-1 mb-1">Download Sample</button>
                                    </div>
                                </div>
