 ...
 * Root Page Session Details
 * --------------------------------------------------------------------------
 */
import IndexAcadMstSetupSession from "../../../../../../pages/organization/academics/setup/masters/MstSetupSession/IndexAcadMstSetupSession";
import AddEditAcadMstSetupSession from "../../../../../../pages/organization/academics/setup/masters/MstSetupSession/AddEditAcadMstSetupSession";
...
const AcadMstSetupSession = (props) => {
    ...
    useEffect(() => {
        //if (MyComponent == "IndexAcadMstSetupSession") {
        //    fetchParentDefaultData(SessionId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
        //else if (MyComponent == "AddEditAcadMstSetupSession") {
        fetchParentDefaultData(SessionId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
    }, []);
    ...
    const fetchParentDefaultData = async (parmSessionId, parmRowPerPage, parmCurrentPage, parmSearchBy, parmSearchValue) => {
        setRowPerPage(parmRowPerPage);
        setCurrentPage(parmCurrentPage);
        setSearchBy(parmSearchBy);
        setSearchValue(parmSearchValue);
        setSessionId(parmSessionId);
        ...
        let GetSessionDetailsUri = APIConfig.Academics.Session.GetSessionDetailsUri;
        GetSessionDetailsUri = GetSessionDetailsUri
            .replace('<SessionId>', parmSessionId)
        ...
        //console.log(GetSessionDetailsUri);
        instance({
            'method': 'GET',
            'url': GetSessionDetailsUri
        }).then((response) => {
            //debugger;
    ...
    async function funcDeleteRecord(rowData) {
        ...
        let DeleteSessionsDetailsUri = APIConfig.Academics.Session.DeleteSessionsDetailsUri;
        DeleteSessionsDetailsUri = DeleteSessionsDetailsUri
            .replace('<SessionId>', id)
            .replace('<DeletedBy>', Cookie.loggedInUserId)
        instance({
            'method': 'DELETE',
            'url': DeleteSessionsDetailsUri
        }).then((response) => {
            setHasAPIError(false);
            //debugger;
            //console.log(response.data);
        ...
        <>
            {(() => {
                ...
                if (DefaultDynamicAPIResponse) {
                    ...
                    //}
                    //if (MyComponent == "AddEditAcadMstSetupSession") {
                    //    return (
                    //        <>
                    //            <div className="full-doc">
                    //                <button className="btn btn-primary btn-sm"
