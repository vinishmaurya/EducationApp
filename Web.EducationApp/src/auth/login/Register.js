...
const pageTitle = "Registration With Education System";
                                    ...
                                    <div className="card-body py-5 px-md-5">
                                        ...
                                        <form action="/action_page.php">
                                            <div className="mb-3 mt-3">
                                                <label htmlFor="email" className="form-label">Education Category:</label>
                                                <select className="form-select" aria-label="Default select example">
                                                    <option defaultValue>Open this select menu</option>
                                                    <option value="1">School</option>
                                                    <option value="2">Institute</option>
                                                    <option value="3">Coaching Centre </option>
                                                </select>
                                            </div>
                                            {
                                                //<div className="mb-3 mt-3">
                                                //    <label htmlFor="NameOfOrganization" className="form-label">Name Of Organization:</label>
                                                //    <input type="name" className="form-control" id="NameOfOrganization" placeholder="Enter name of organization" name="NameOfOrganization"></input>
                                                //</div>
                                            }
                                            <div className="mb-3 mt-3">
