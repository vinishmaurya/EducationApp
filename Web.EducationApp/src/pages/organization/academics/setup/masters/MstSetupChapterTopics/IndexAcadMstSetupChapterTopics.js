 ...
 * Index Page ChapterTopics Master Details
 * --------------------------------------------------------------------------
 */
...
const AcadMstSetupChapterTopics = (props) => {
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "ChapterTopicsMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "ChapterTopics Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "ChapterTopicsMasterData" + format(new Date(), '-ddMMyyyykkmmss');
            ...
            <div className="col-6">
                <div className="card">
                    <div className="card-header">
                        <h5 className="card-title">Chapter Topics Data</h5>
                        <a className="heading-elements-toggle"><i className="la la-ellipsis-v font-ChapterTopics-3"></i></a>
