 ...
 * Index Page Student Category Master Details
 * --------------------------------------------------------------------------
 */
...
const IndexAcadMstSetupStudentCategory = (props) => {
    //debugger;
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "StudentCategoryMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "StudentCategory Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "StudentCategoryMasterData" + format(new Date(), '-ddMMyyyykkmmss');
            ...
            <div className="col-6">
                <div className="card">
                    <div className="card-header">
                        <h5 className="card-title">Student Category Data</h5>
                        <a className="heading-elements-toggle"><i className="la la-ellipsis-v font-StudentCategory-3"></i></a>
...
export default IndexAcadMstSetupStudentCategory;
