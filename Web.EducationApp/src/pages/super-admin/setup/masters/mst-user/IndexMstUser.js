 ...
 * Index Page User Master Details
 * --------------------------------------------------------------------------
 */
...
const IndexMstUser = (props) => {
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "UserMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "User Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "UserMasterData" + format(new Date(), '-ddMMyyyykkmmss');
