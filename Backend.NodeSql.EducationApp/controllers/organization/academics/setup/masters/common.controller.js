...
const GetAllSessionList = async (req, res, next) => {
    /*  #swagger.tags = ['Academics.Common']
        #swagger.description = ''
    */
    ServiceResult.Message = null;
...
const GetAllStudentCategoryList = async (req, res, next) => {
    /*  #swagger.tags = ['Academics.Common']
        #swagger.description = ''
    */
    ServiceResult.Message = null;
    ...
    try {
        ...
        await poolPromise.connect().then(function (pool) {
            ...
            request.execute("[ACAD].[USP_SvcGetStudentCategoryList]", function (err, recordset) {
                if (err) {
                    console.log(err);
                    sql.close();
                    ServiceResult.Message = "Failed to parse api response!";
