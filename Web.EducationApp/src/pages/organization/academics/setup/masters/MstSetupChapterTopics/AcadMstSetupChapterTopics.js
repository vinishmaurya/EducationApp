 ...
 * Root Page ChapterTopics Details
 * --------------------------------------------------------------------------
 */
import IndexAcadMstSetupChapterTopics from "../../../../../../pages/organization/academics/setup/masters/MstSetupChapterTopics/IndexAcadMstSetupChapterTopics";
import AddEditAcadMstSetupChapterTopics from "../../../../../../pages/organization/academics/setup/masters/MstSetupChapterTopics/AddEditAcadMstSetupChapterTopics";
...
const AcadMstSetupChapterTopics = (props) => {
    ...
    const [ChapterTopicsId, setChapterTopicsId] = useState(0);
    ...
    useEffect(() => {
        //if (MyComponent == "IndexAcadMstSetupChapterTopics") {
        //    fetchParentDefaultData(ChapterTopicsId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
        //else if (MyComponent == "AddEditAcadMstSetupChapterTopics") {
        fetchParentDefaultData(ChapterTopicsId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
    }, []);
    ...
    const fetchParentDefaultData = async (parmChapterTopicsId, parmRowPerPage, parmCurrentPage, parmSearchBy, parmSearchValue) => {
        setRowPerPage(parmRowPerPage);
        setCurrentPage(parmCurrentPage);
        setSearchBy(parmSearchBy);
        setSearchValue(parmSearchValue);
        setChapterTopicsId(parmChapterTopicsId);
        ...
        let GetChapterTopicsDetailsUri = APIConfig.Academics.ChapterTopics.GetChapterTopicsDetailsUri;
        GetChapterTopicsDetailsUri = GetChapterTopicsDetailsUri
            .replace('<ChapterTopicsId>', parmChapterTopicsId)
        ...
        instance({
            'method': 'GET',
            'url': GetChapterTopicsDetailsUri
        }).then((response) => {
            //debugger;
    ...
    async function funcDeleteRecord(rowData) {
        ...
        let DeleteChapterTopicssDetailsUri = APIConfig.Academics.ChapterTopics.DeleteChapterTopicssDetailsUri;
        DeleteChapterTopicssDetailsUri = DeleteChapterTopicssDetailsUri
            .replace('<ChapterTopicsId>', id)
            .replace('<DeletedBy>', Cookie.loggedInUserId)
        instance({
            'method': 'DELETE',
            'url': DeleteChapterTopicssDetailsUri
        }).then((response) => {
            setHasAPIError(false);
            //debugger;
            //console.log(response.data);
                ...
                if (DefaultDynamicAPIResponse) {
                    ...
                    return (
                        <>
                            ...
                            <div className="row">
                                <AddEditAcadMstSetupChapterTopics
                                    pageTitle={data.innerComponentName}
                                    dataRow={DataRow}
                                    funcBackToIndex={loadComponent}
                                />
                                <IndexAcadMstSetupChapterTopics
                                    ...
                                    setChapterTopicsId={ChapterTopicsId}
                    ...
                    //}
                    //if (MyComponent == "AddEditAcadMstSetupChapterTopics") {
                    //    return (
                    //        <>
                    //            <div className="full-doc">
                    //                <button className="btn btn-primary btn-sm"
