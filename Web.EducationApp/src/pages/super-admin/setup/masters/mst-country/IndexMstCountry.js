 ...
 * Index Page Country Master Details
 * --------------------------------------------------------------------------
 */
...
const IndexMstCountry = (props) => {
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "CountryMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "Country Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "CountryMasterData" + format(new Date(), '-ddMMyyyykkmmss');
...
export default IndexMstCountry;
