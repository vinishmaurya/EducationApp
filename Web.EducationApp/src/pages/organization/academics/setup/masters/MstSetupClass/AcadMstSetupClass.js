 ...
 * Root Page Class Details
 * --------------------------------------------------------------------------
 */
import IndexAcadMstSetupClass from "../../../../../../pages/organization/academics/setup/masters/MstSetupClass/IndexAcadMstSetupClass";
import AddEditAcadMstSetupClass from "../../../../../../pages/organization/academics/setup/masters/MstSetupClass/AddEditAcadMstSetupClass";
...
const AcadMstSetupClass = (props) => {
    ...
    useEffect(() => {
        //if (MyComponent == "IndexAcadMstSetupClass") {
        //    fetchParentDefaultData(ClassId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
        //else if (MyComponent == "AddEditAcadMstSetupClass") {
        fetchParentDefaultData(ClassId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
    }, []);
    ...
    const fetchParentDefaultData = async (parmClassId, parmRowPerPage, parmCurrentPage, parmSearchBy, parmSearchValue) => {
        setRowPerPage(parmRowPerPage);
        setCurrentPage(parmCurrentPage);
        setSearchBy(parmSearchBy);
        setSearchValue(parmSearchValue);
        setClassId(parmClassId);
        ...
        let GetClassDetailsUri = APIConfig.Academics.Class.GetClassDetailsUri;
        GetClassDetailsUri = GetClassDetailsUri
            .replace('<ClassId>', parmClassId)
    ...
    async function funcDeleteRecord(rowData) {
        ...
        let DeleteClassDetailsUri = APIConfig.Academics.Class.DeleteClassDetailsUri;
        DeleteClassDetailsUri = DeleteClassDetailsUri
            .replace('<ClassId>', id)
            .replace('<DeletedBy>', Cookie.loggedInUserId)
        instance({
            'method': 'DELETE',
            'url': DeleteClassDetailsUri
        }).then((response) => {
            setHasAPIError(false);
            //debugger;
            //console.log(response.data);
        ...
        <>
            {(() => {
                ...
                if (DefaultDynamicAPIResponse) {
                    ...
                    //}
                    //if (MyComponent == "AddEditAcadMstSetupClass") {
                    //    return (
                    //        <>
                    //            <div className="full-doc">
                    //                <button className="btn btn-primary btn-sm"
...
export default AcadMstSetupClass;
