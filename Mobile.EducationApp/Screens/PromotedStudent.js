...
const PromoteStudent = () => {
    ...
    const [Yearsid, setYearsid] = useState(null);
    const data = [
    ...
    const [Years, setYears] = useState(function () {
        let api_data = [
                ...
                <View style={{ marginHorizontal: 15, marginBottom: 30 }}>
                    <View>
                        <View style={{ marginHorizontal: 0, marginVertical: 20 }}>
                            <Text style={{ fontSize: 19, fontWeight: 'bold' }}>Promote Student In Next Session</Text>
                        </View>
                        <View>
                            ...
                            <Text style={{ fontSize: 16, fontWeight: '400' }}>Promote Class<Text style={{ color: "red" }}> *</Text></Text>
                            <View style={{ marginTop: 0 }}>
                                <Dropdown bindDataAwardCategory={Category} my_value={Categoryid} my_onChangeText={setCategoryid} />
                            </View>
                            <Text style={{ fontSize: 16, fontWeight: '400' }}>Promote In<Text style={{ color: "red" }}> *</Text></Text>
                            <View style={{ marginTop: 0 }}>
                                <Dropdown bindDataAwardCategory={Years} my_value={Yearsid} my_onChangeText={setYearsid} />
                            </View>
                        </View>
