 ...
 * Index Page Role Master Details
 * --------------------------------------------------------------------------
 */
...
const IndexMstRole = (props) => {
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "RoleMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "Role Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "RoleMasterData" + format(new Date(), '-ddMMyyyykkmmss');
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-header">
                                    <h5 className="card-title">Role Data</h5>
