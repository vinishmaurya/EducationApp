 ...
 * Index Page Section Master Details
 * --------------------------------------------------------------------------
 */
...
const IndexAcadMstSetupSection = (props) => {
    //debugger;
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "SectionMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "Section Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "SectionMasterData" + format(new Date(), '-ddMMyyyykkmmss');
            ...
            <div className="col-6">
                <div className="card">
                    <div className="card-header">
                        <h5 className="card-title">Section Data</h5>
                        <a className="heading-elements-toggle"><i className="la la-ellipsis-v font-Section-3"></i></a>
...
export default IndexAcadMstSetupSection;
