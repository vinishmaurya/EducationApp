 ...
 * Index Page Class Master Details
 * --------------------------------------------------------------------------
 */
...
const IndexAcadMstSetupClass = (props) => {
    //debugger;
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "ClassMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "Class Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "ClassMasterData" + format(new Date(), '-ddMMyyyykkmmss');
            ...
            <div className="col-6">
                <div className="card">
                    <div className="card-header">
                        ...
                        <a className="heading-elements-toggle"><i className="la la-ellipsis-v font-Class-3"></i></a>
...
export default IndexAcadMstSetupClass;
