        ...
        <>
            <div class="row">
                    ...
                    <div class="card card-demo">
                        <div class="card-body">
                            <ul className="nav nav-tabs nav-top-border no-hover-bg">
                                <li className="nav-item"> <a className="nav-link active" id="base-tab11" data-toggle="tab" aria-controls="tab11" href="#tab11" aria-expanded="true">Student Class Mapping</a> </li>
                            </ul>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card card-demo">
                        <div class="card-body">
                            <h3 class="card-title">Student Class Mapping List</h3>
                            <div className="row">
