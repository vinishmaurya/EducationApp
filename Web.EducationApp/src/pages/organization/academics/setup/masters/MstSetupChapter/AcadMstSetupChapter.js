 ...
 * Root Page Chapter Details
 * --------------------------------------------------------------------------
 */
import IndexAcadMstSetupChapter from "../../../../../../pages/organization/academics/setup/masters/MstSetupChapter/IndexAcadMstSetupChapter";
import AddEditAcadMstSetupChapter from "../../../../../../pages/organization/academics/setup/masters/MstSetupChapter/AddEditAcadMstSetupChapter";
...
const AcadMstSetupChapter = (props) => {
    ...
    useEffect(() => {
        //if (MyComponent == "IndexAcadMstSetupChapter") {
        //    fetchParentDefaultData(ChapterId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
        //else if (MyComponent == "AddEditAcadMstSetupChapter") {
        fetchParentDefaultData(ChapterId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
    }, []);
    ...
    const fetchParentDefaultData = async (parmChapterId, parmRowPerPage, parmCurrentPage, parmSearchBy, parmSearchValue) => {
        setRowPerPage(parmRowPerPage);
        setCurrentPage(parmCurrentPage);
        setSearchBy(parmSearchBy);
        setSearchValue(parmSearchValue);
        setChapterId(parmChapterId);
        ...
        let GetChapterDetailsUri = APIConfig.Academics.Chapter.GetChapterDetailsUri;
        GetChapterDetailsUri = GetChapterDetailsUri
            .replace('<ChapterId>', parmChapterId)
    ...
    async function funcDeleteRecord(rowData) {
        ...
        let DeleteChaptersDetailsUri = APIConfig.Academics.Chapter.DeleteChaptersDetailsUri;
        DeleteChaptersDetailsUri = DeleteChaptersDetailsUri
            .replace('<ChapterId>', id)
            .replace('<DeletedBy>', Cookie.loggedInUserId)
        instance({
            'method': 'DELETE',
            'url': DeleteChaptersDetailsUri
        }).then((response) => {
            setHasAPIError(false);
            //debugger;
            //console.log(response.data);
        ...
        <>
            {(() => {
                ...
                if (DefaultDynamicAPIResponse) {
                    ...
                    //}
                    //if (MyComponent == "AddEditAcadMstSetupChapter") {
                    //    return (
                    //        <>
                    //            <div className="full-doc">
                    //                <button className="btn btn-primary btn-sm"
...
export default AcadMstSetupChapter;
