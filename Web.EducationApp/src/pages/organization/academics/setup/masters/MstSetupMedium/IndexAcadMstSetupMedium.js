 ...
 * Index Page Medium Master Details
 * --------------------------------------------------------------------------
 */
...
const IndexAcadMstSetupMedium = (props) => {
    //debugger;
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "MediumMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "Medium Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "MediumMasterData" + format(new Date(), '-ddMMyyyykkmmss');
            ...
            <div className="col-6">
                <div className="card">
                    <div className="card-header">
                        <h5 className="card-title">Medium Data</h5>
...
export default IndexAcadMstSetupMedium;
