 ...
 * Root Page Student Category Details
 * --------------------------------------------------------------------------
 */
import IndexAcadMstSetupStudentCategory from "../../../../../../pages/organization/academics/setup/masters/MstSetupStudentCategory/IndexAcadMstSetupStudentCategory";
import AddEditAcadMstSetupStudentCategory from "../../../../../../pages/organization/academics/setup/masters/MstSetupStudentCategory/AddEditAcadMstSetupStudentCategory";
...
const AcadMstSetupStudentCategory = (props) => {
    ...
    const [StudentCategoryId, setStudentCategoryId] = useState(0);
    ...
    useEffect(() => {
        //if (MyComponent == "IndexAcadMstSetupStudentCategory") {
        //    fetchParentDefaultData(StudentCategoryId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
        //else if (MyComponent == "AddEditAcadMstSetupStudentCategory") {
        fetchParentDefaultData(StudentCategoryId, RowPerPage, CurrentPage, SearchBy, SearchValue);
        //}
    }, []);
    ...
    const fetchParentDefaultData = async (parmStudentCategoryId, parmRowPerPage, parmCurrentPage, parmSearchBy, parmSearchValue) => {
        setRowPerPage(parmRowPerPage);
        setCurrentPage(parmCurrentPage);
        setSearchBy(parmSearchBy);
        setSearchValue(parmSearchValue);
        setStudentCategoryId(parmStudentCategoryId);
        ...
        let GetStudentCategoryDetailsUri = APIConfig.Academics.StudentCategory.GetStudentCategoryDetailsUri;
        GetStudentCategoryDetailsUri = GetStudentCategoryDetailsUri
            .replace('<StudentCategoryId>', parmStudentCategoryId)
        ...
        instance({
            'method': 'GET',
            'url': GetStudentCategoryDetailsUri
        }).then((response) => {
            //debugger;
    ...
    async function funcDeleteRecord(rowData) {
        ...
        let DeleteStudentCategorysDetailsUri = APIConfig.Academics.StudentCategory.DeleteStudentCategorysDetailsUri;
        DeleteStudentCategorysDetailsUri = DeleteStudentCategorysDetailsUri
            .replace('<StudentCategoryId>', id)
            .replace('<DeletedBy>', Cookie.loggedInUserId)
        instance({
            'method': 'DELETE',
            'url': DeleteStudentCategorysDetailsUri
        }).then((response) => {
            setHasAPIError(false);
            //debugger;
            //console.log(response.data);
                ...
                if (DefaultDynamicAPIResponse) {
                    ...
                    return (
                        <>
                            ...
                            <div className="row">
                                <AddEditAcadMstSetupStudentCategory
                                    pageTitle={data.innerComponentName}
                                    dataRow={DataRow}
                                    funcBackToIndex={loadComponent}
                                />
                                <IndexAcadMstSetupStudentCategory
                                    ...
                                    setStudentCategoryId={StudentCategoryId}
                    ...
                    //}
                    //if (MyComponent == "AddEditAcadMstSetupStudentCategory") {
                    //    return (
                    //        <>
                    //            <div className="full-doc">
                    //                <button className="btn btn-primary btn-sm"
