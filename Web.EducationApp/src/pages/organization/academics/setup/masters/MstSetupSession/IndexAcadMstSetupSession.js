 ...
 * Index Page Session Master Details
 * --------------------------------------------------------------------------
 */
...
const IndexAcadMstSetupSession = (props) => {
    //debugger;
    ...
    const funcHandelPDFExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "SessionMasterData" + format(new Date(), '-ddMMyyyykkmmss'), title = "Session Master Data (" + format(new Date(), 'dd/MM/yyyy kk:mm:ss') + ")";
    ...
    const funcHandelCSVExport = async () => {
        if (props.defaultDynamicAPIResponse.DataList.length > 0) {
            let filename = "SessionMasterData" + format(new Date(), '-ddMMyyyykkmmss');
            ...
            <div className="col-6">
                <div className="card">
                    <div className="card-header">
                        <h5 className="card-title">Session Data</h5>
                        <a className="heading-elements-toggle"><i className="la la-ellipsis-v font-Session-3"></i></a>
...
export default IndexAcadMstSetupSession;
